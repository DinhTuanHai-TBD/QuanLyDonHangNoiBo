        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WarehouseLimit = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductSkus_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SlaDeadline = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryStocks_ProductSkus_SkuId",
                        column: x => x.SkuId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferenceCode = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Note = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryTransactions_ProductSkus_SkuId",
                        column: x => x.SkuId,
                        principalTable: "ProductSkus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CodCollections_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CodCollections_Users_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ShipmentCode = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    OrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DriverId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    ...
                    ProofOfDeliveryUrl = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIInsights_TenantId_Severity_CreatedAt",
                table: "AIInsights",
                columns: new[] { "TenantId", "Severity", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_TenantId_EntityName_EntityId_CreatedAt",
                table: "AuditLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CodCollections_DriverId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CodCollections_TenantId_OrderId",
                table: "CodCollections",
                columns: new[] { "TenantId", "OrderId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CodCollections_TenantId_Status_CollectedAt",
                table: "CodCollections",
                columns: new[] { "TenantId", "Status", "CollectedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryStocks_SkuId",
                table: "InventoryStocks",
                column: "SkuId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryStocks_TenantId_WarehouseId_SkuId",
                table: "InventoryStocks",
                columns: new[] { "TenantId", "WarehouseId", "SkuId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_TenantId_ReferenceCode",
                table: "InventoryTransactions",
                columns: new[] { "TenantId", "ReferenceCode" });

            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_TenantId_WarehouseId_SkuId_CreatedAt",
                table: "InventoryTransactions",
                columns: new[] { "TenantId", "WarehouseId", "SkuId", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_TenantId_CustomerId_CreatedAt",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_TenantId_WarehouseId_Status",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderStatusHistories_TenantId_OrderId_ChangedAt",
                table: "OrderStatusHistories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSkus_TenantId_Barcode",
                table: "ProductSkus",
                columns: new[] { "TenantId", "Barcode" });

            migrationBuilder.CreateIndex(
                name: "IX_ProductSkus_TenantId_SkuCode",
                table: "ProductSkus",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipments_TenantId_DriverId_Status",
                table: "Shipments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipments_TenantId_ShipmentCode",
                table: "Shipments",
                columns: new[] { "TenantId", "ShipmentCode" },
                unique: true);
